...
public class GetStringCommand implements NoSQLCommand {

	private String key;
	public static final String COMMAND_KEY = "GET_STRING";
	
	public GetStringCommand(String key) {
		this.key = key;
	}
